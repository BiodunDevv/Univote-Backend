...
const SEEDED_AWS_THRESHOLD = Number(
  process.env.AWS_REKOGNITION_SIMILARITY_THRESHOLD || 70,
);
const SEEDED_LIVENESS_THRESHOLD = Number(
  process.env.AWS_REKOGNITION_LIVENESS_THRESHOLD || 70,
);
    ...
    biometrics: {
      ...
      providers: {
        aws_rekognition: {
          ...
          liveness_threshold: SEEDED_LIVENESS_THRESHOLD,
        },
      },
    },
  });
  ...
  await VerificationLog.insertMany([
    {
      ...
      liveness_session_id: "seed-liveness-pass-accepted",
      liveness_status: "SUCCEEDED",
      liveness_confidence: 98.6,
      liveness_threshold: SEEDED_LIVENESS_THRESHOLD,
      compare_confidence: 94.2,
      compare_threshold: SEEDED_AWS_THRESHOLD,
      matched_face_id: seededStudent.aws_face_id,
      decision_source: "liveness_reference_image",
      fail_streak: 0,
      ...
      timestamp: addDays(new Date(), -18),
      meta: {
        scenario: "accepted_live_compare_success",
    ...
    },
    {
      ...
      threshold_used: SEEDED_AWS_THRESHOLD,
      liveness_session_id: "seed-liveness-pass-low-confidence",
      liveness_status: "SUCCEEDED",
      liveness_confidence: 96.1,
      liveness_threshold: SEEDED_LIVENESS_THRESHOLD,
      compare_confidence: 71.4,
      compare_threshold: SEEDED_AWS_THRESHOLD,
      matched_face_id: seededStudent.aws_face_id,
      decision_source: "liveness_reference_image",
      fail_streak: 1,
      ...
      meta: {
        scenario: "rejected_low_confidence_after_liveness_success",
      },
    },
    {
      tenant_id: tenant._id,
      ...
      threshold_used: SEEDED_AWS_THRESHOLD,
      liveness_session_id: "seed-liveness-failed",
      liveness_status: "FAILED",
      liveness_confidence: 63.2,
      liveness_threshold: SEEDED_LIVENESS_THRESHOLD,
      ...
      is_genuine_attempt: null,
      reviewed_by: tenantAdminId,
      reviewed_at: new Date(),
      review_note: "Seeded liveness rejection for operational analytics.",
      provider: "aws_rekognition",
      ...
      meta: {
        scenario: "rejected_liveness_failed",
      },
    },
    {
      tenant_id: tenant._id,
      ...
      confidence_score: null,
      threshold_used: SEEDED_AWS_THRESHOLD,
      liveness_session_id: "seed-liveness-expired",
      ...
      lockout_expires_at: null,
      result: "rejected",
      failure_reason: "LIVENESS_SESSION_EXPIRED",
      is_genuine_attempt: null,
      reviewed_by: tenantAdminId,
      reviewed_at: new Date(),
      review_note: "Seeded expired liveness session for operational analytics.",
      provider: "aws_rekognition",
      device_id: "seeded-web-device",
      ...
      meta: {
        scenario: "rejected_liveness_expired",
      },
    },
    {
      tenant_id: tenant._id,
      ...
      threshold_used: SEEDED_AWS_THRESHOLD,
      liveness_session_id: "seed-liveness-lockout",
      liveness_status: "SUCCEEDED",
      liveness_confidence: 95.4,
      liveness_threshold: SEEDED_LIVENESS_THRESHOLD,
      compare_confidence: 52.8,
      compare_threshold: SEEDED_AWS_THRESHOLD,
      matched_face_id: seededStudent.aws_face_id,
      decision_source: "liveness_reference_image",
      fail_streak: 3,
      lockout_triggered: true,
      lockout_expires_at: new Date(Date.now() + 5 * 60 * 1000),
      result: "rejected",
      failure_reason: "LOW_CONFIDENCE",
      is_genuine_attempt: null,
      reviewed_by: tenantAdminId,
      reviewed_at: new Date(),
      review_note: "Seeded low-confidence compare rejection that triggers lockout analytics.",
      provider: "aws_rekognition",
      device_id: "seeded-ios-device-lockout",
      ip_address: "127.0.0.5",
      geo_location: { lat: 7.4211, lng: 4.9081 },
      image_url: STUDENT_PHOTO_URL,
      timestamp: addDays(new Date(), -0.5),
      meta: {
        scenario: "rejected_low_confidence_lockout_triggered",
      },
    },
  ]);
